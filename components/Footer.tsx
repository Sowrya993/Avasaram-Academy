...
import { Github, Linkedin, Instagram, Phone, Mail, MapPin, ArrowRight, X } from 'lucide-react';
  ...
  return (
    <footer className="bg-stone-900 text-stone-300 mt-auto">
      ...
      <div className="fixed bottom-6 left-6 z-50">
        {/* Chat Popup */}
        {isWhatsAppOpen && (
          <div className="absolute bottom-20 left-0 w-80 bg-white rounded-2xl shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300">
            {/* Header */}
            <div className="bg-green-500 px-4 py-4 flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-12 h-12 rounded-full overflow-hidden bg-white p-0.5">
                  <img
                    src="/logo-bg.png"
                    alt="Avasaram Academy"
                    className="w-full h-full object-cover rounded-full"
                  />
                </div>
                <div>
                  <h4 className="text-white font-bold text-base">Avasaram Academy</h4>
            ...
            {/* Chat Body */}
            <div className="bg-[#e5ddd5] p-4 bg-opacity-50" style={{ backgroundImage: "url('data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAADIAAAAyBAMAAADsEZWCAAAAElBMVEXd3d3i4uLn5+fs7Ozx8fH29vYpLRzMAAAACXBIWXMAAAsTAAALEwEAmpwYAAAAOElEQVQ4y2NgGAWjYBTQFjAyMjExMTEyMjIyMjAA2YyMQDYjIyMTE5DNyAhkMzIyMjExMTEyjgIqAgBZ2gPzQrb2CQAAAABJRU5ErkJggg==')" }}>
              <div className="bg-white rounded-lg p-4 shadow-sm max-w-[90%] relative">
                ...
                <p className="text-gray-800 text-sm font-medium mb-1">Avasaram Academy</p>
                <p className="text-gray-600 text-sm leading-relaxed">
                  Hi there! Welcome to <strong>Avasaram Academy</strong> - Your Gateway to AI & Tech Excellence!
                </p>
                <p className="text-gray-600 text-sm leading-relaxed mt-2">
                  How can we help you today? Ask us about our courses, career support, or anything tech-related!
                </p>
            ...
            <div className="p-4 bg-gray-50">
              <a
                href="https://wa.me/918688545761?text=Hi%20Avasaram%20Academy!%20I%20want%20to%20know%20more%20about%20your%20courses."
                target="_blank"
                rel="noopener noreferrer"
                className="w-full flex items-center justify-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-3 px-4 rounded-full transition-all shadow-lg shadow-green-500/30 hover:shadow-green-500/50"
              >
                <svg
        ...
        <button
          ...
          className={`w-14 h-14 bg-green-500 hover:bg-green-600 rounded-full flex items-center justify-center shadow-lg shadow-green-500/30 transition-all hover:scale-110 ${isWhatsAppOpen ? 'rotate-0' : ''}`}
